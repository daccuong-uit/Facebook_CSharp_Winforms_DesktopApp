...
{
    public partial class WindowControlLight : UserControl
    {
        ...
        public void DarkMode(bool isDarkMode)
        {
            if (isDarkMode)
            {
                ptbClose.Image = Properties.Resources._24_white_close;
                ptbMinimize.Image = Properties.Resources._24_white_minimize;
                ptbMaximize.Image = Properties.Resources._24_white_square;
                btnOptional.Image = Properties.Resources._16_white_option;
                lblLastMessContact.ForeColor = Color.White;
            }
            else
            {
                ptbClose.Image = Properties.Resources._24_black_close;
                ptbMinimize.Image = Properties.Resources._24_black_minimize;
                ptbMaximize.Image = Properties.Resources._24_black_square;
                btnOptional.Image = Properties.Resources._16_black_option;
                lblLastMessContact.ForeColor = Color.Black;
            }
        }
